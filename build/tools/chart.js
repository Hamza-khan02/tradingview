 ...
 */
export async function changeSymbol(cdpClient, symbol) {
...
export async function changeTimeframe(cdpClient, timeframe) {
...
export async function refreshChart(cdpClient) {
...
export async function getChartScreenshot(cdpClient) {
...
export async function getChartLayout(cdpClient) {
