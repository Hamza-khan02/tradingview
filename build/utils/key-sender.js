...
const KEY_MAP = {
    // Letters
    ...Object.fromEntries(Array.from("abcdefghijklmnopqrstuvwxyz").map((char) => [
        char,
    ...
    // Numbers
    ...Object.fromEntries(Array.from("0123456789").map((char) => [
        char,
...
export class KeySender {
    ...
    async sendRawKey(key, code, keyCode, shift) {
